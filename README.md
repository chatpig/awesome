...
current scheme is Ether and all its layer-2 relatives charge 0.001 ($3); the cheapest option is Matic/POL, charge 0.1 (¢7); all of them will go into 🐷(ω)'s pocket without any commitment; fatfat💰;
...
*layer-2
- Linea (id: `59144`; compiler: `^0.8.19`) [contract address](https://lineascan.build/address/0x6c4c92595E9c58603ae712e0188a4a3Dcd87dEdd) *not supported well; default 2nd mainnet in metamask
...
*layer-1
- Sepolia (id: `11155111`; compiler: `^0.8.27`**) [contract address](https://sepolia.etherscan.io/address/0x3822671bED33573Ce9D7aB728803610559F3859F)***the latest compiler on test
- Holesky (id: `17000`; compiler: `^0.8.27`**) [contract address](https://holesky.etherscan.io/address/0x5F7ae3DEB7ce9DDC244DE3e1b1BebdC3901dc562) ***the latest compiler on test
- Hoodi (id: `560048`; compiler: `^0.8.30`**) [contract address](https://hoodi.etherscan.io/address/0xB95BE2Acdf69E9A5357606f7031933c598259772) ***the latest compiler on test

*layer-2
- Optimism (id: `11155420`; compiler: `^0.8.26`) [contract address](https://sepolia-optimism.etherscan.io/address/0x35aAB2F85f91682Ae0048A6b32a6c3e045335da1)
- Arbitrum (id: `421614`; compiler: `^0.8.26`) [contract address](https://sepolia.arbiscan.io/address/0x3a37D12EB3249eBbe69884A0439b64512d8E004F)
- Base (id: `84532`; compiler: `^0.8.26`) [contract address](https://sepolia.basescan.org/address/0x505dbc2C6F0db20d3cCdB874465e61cbF5e9cA17)
- Cyber (id: `111557560`; compiler: `^0.8.26`) [contract address](https://cyber-testnet.socialscan.io/address/0xB95BE2Acdf69E9A5357606f7031933c598259772)
...
- Morph (id: `2810`; compiler: `^0.8.24`*) [contract address](https://explorer-holesky.morphl2.io/address/0xB4e31320Be11bAab45817414274a3e98577bDafd) *new compiler: data fetching error
...
*side
- Amoy (id: `80002`; compiler: `^0.8.26`) [contract address](https://www.oklink.com/amoy/address/0x2b76DFFf6B1E9DEd9F7D5c564cAD440667DC4E45)
- Binance (id: `97`; compiler: `^0.8.26`) [contract address](https://testnet.bscscan.com/address/0x17F6E6E620cec1054b9E1F15b461Ca8deAfD904c)
...
#### publication📚
medium article [discover the hidden gem of gguf (unleash the power of editable tokens)](https://medium.com/@whiteblanksheet/discover-the-hidden-functionality-of-gguf-us-unleash-the-power-of-editable-tokens-b8fb92a76eac) *FREE read; no membership needed
